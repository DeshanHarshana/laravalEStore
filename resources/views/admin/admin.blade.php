...
<tr style="background-color:aquamarine; text-align:center">
    <td><form action="{{ route('showadmindetails') }}" method="get"> @csrf <button type="submit" class="btn btn-success" style="width: 100%">Admin Name</button></form></td>
    ...
    <tr style="height: 40%">
        <td colspan="4" style="width: 100%; height:100%; text-align:center"><h1>Admin Panal</h1><td>
    </tr>
